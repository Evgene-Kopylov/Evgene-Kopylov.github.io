...
pub const PROJECTILE_TEXTURE_PATH: &str = "../assets/pointer/projectile_glow_large.png";
pub const PROJECTILE_COLOR: Color = Color::new(1.00, 0.96, 0.84, 1.00);
pub const MAIN_UNIT_SPEED: f32 = 500.;
pub const MAIN_UNIT_SHOOT_DELAY: f32 = 0.06;
...
// pub const MAIN_UNIT_SHOOT_SOUND_ASSET: &str = "../assets/sound/XAL_Weapon.wav" // Хорошо
// pub const MAIN_UNIT_SHOOT_SOUND_ASSET: &str = "../assets/sound/URLWeapon.wav" // Хорошо
// pub const MAIN_UNIT_SHOOT_SOUND_ASSET: &str ="../assets/sound/URSWeapon.wav" // Очень хорошо
